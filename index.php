...
<head>
  ...
  <title>Mon CV</title>
  <link rel="stylesheet" href="./btnRetour.css" />
    ...
    <section>
      <aside class="profil">
        ...
        <div class="blokk">
          ...
          <a href="http://dev-workshop.alwaysdata.net/portail">Portfolio</a> / <a href="https://github.com/BoTom51/">Github</a>
        </div>
        ...
        <div class="relative">
          ...
          <div class="contenu deux">
            ...
            <div class="iconLanguage">
              <!-- SVG langages -->
              <?php include("./img/langage_svg.php"); ?>
            </div>
          </div>
        </div>
        <div class="relative">
